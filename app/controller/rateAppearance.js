        ...
        result
          ...
          .then((ratedAgain) => {
            if (ratedAgain) {
              ...
              res.send({
                code: 200,
                message: infoMessages.SUCCESS_APPEARANCE_RATED,
              ...
              logger.error(
                infoMessages.ERROR_RATING_APPEARANCE +
                  "[Error in appearance rating.]",
                { service: "rateApp" }
              );
              res.send({
                code: 204,
                message: infoMessages.ERROR_RATING_APPEARANCE,
              });
            }
          })
          .catch((error) => {
...
exports.getRateAppearance = async function (req, res) {
  db.rate
    ...
    .then((appearanceRate) => {
      ...
      if (appearanceRate) var responseRateAppearance = appearanceRate.rate;
      res.send({
        code: 200,

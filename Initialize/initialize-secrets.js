...
const vault = require("node-vault")({
  apiVersion: vaultCredentials.VAULT_VERSION,
  endpoint: vaultCredentials.VAULT_HOST,
});

const runSecretFetcher = async () => {
 /*  console.log(JSON.stringify({
    "RID": vaultCredentials.ROLE_ID,
    "SEC": vaultCredentials.SECRET_ID,
    "HOST": vaultCredentials.VAULT_HOST,
  })); */
